...
slist:	slist stmt	{$$=makenode(INTEGER,3,NULL,-1,$1,NULL,$2);}
		| stmt	{$$=$1;}
		;
stmt:	ID '=' expr ';'		{$$=makenode(INTEGER,'=',NULL,-1,makenode(INTEGER,ID,$1,-1,NULL,NULL,NULL),NULL,$3);}
		| READ '(' ID ')' ';'	{$$=makenode(INTEGER,READ,NULL,-1,makenode(INTEGER,ID,$3,-1,NULL,NULL,NULL),NULL,NULL);}
...
expr:	expr '+' expr	{$$=makenode(INTEGER,'+',NULL,-1,$1,NULL,$3);}
		...
		| ID 	{$$=makenode(INTEGER,ID,$1,-1,NULL,NULL,NULL);}
		;
%%
